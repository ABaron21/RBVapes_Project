...
public class OrderController {
	...
	public ResponseEntity<Orders> createOrder(@PathVariable Long id, @RequestBody Orders info) {
		return new ResponseEntity<>(this.service.createNew(id, info), HttpStatus.CREATED);
	}
